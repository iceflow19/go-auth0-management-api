...
// GetSettingsResponse get settings response
// swagger:model get_settings_response
type GetSettingsResponse struct {
	...
	// change password
	ChangePassword *GetSettingsResponseChangePassword `json:"change_password,omitempty"`
	...
	// error page
	ErrorPage *GetSettingsResponseErrorPage `json:"error_page,omitempty"`

	// flags
	Flags *GetSettingsResponseFlags `json:"flags,omitempty"`

	// The friendly name of the tenant
	FriendlyName *string `json:"friendly_name,omitempty"`

	// guardian mfa page
	GuardianMfaPage *GetSettingsResponseGuardianMfaPage `json:"guardian_mfa_page,omitempty"`
...
// Validate validates this get settings response
func (m *GetSettingsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetSettingsResponse) validateChangePassword(formats strfmt.Registry) error {
...
func (m *GetSettingsResponse) validateErrorPage(formats strfmt.Registry) error {
...
func (m *GetSettingsResponse) validateFlags(formats strfmt.Registry) error {
...
func (m *GetSettingsResponse) validateGuardianMfaPage(formats strfmt.Registry) error {
...
func (m *GetSettingsResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetSettingsResponse) UnmarshalBinary(b []byte) error {
	var res GetSettingsResponse
