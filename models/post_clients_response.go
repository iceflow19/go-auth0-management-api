...
// PostClientsResponse post clients response
// swagger:model post_clients_response
type PostClientsResponse struct {

	// addons
	Addons PostClientsResponseAddons `json:"addons,omitempty"`
	...
	// client metadata
	ClientMetadata PostClientsResponseClientMetadata `json:"client_metadata,omitempty"`
	...
	// encryption key
	EncryptionKey *PostClientsResponseEncryptionKey `json:"encryption_key,omitempty"`
	...
	// jwt configuration
	JwtConfiguration *PostClientsResponseJwtConfiguration `json:"jwt_configuration,omitempty"`

	// The URL of the client logo (recommended size: 150x150)
	LogoURI string `json:"logo_uri,omitempty"`

	// mobile
	Mobile *PostClientsResponseMobile `json:"mobile,omitempty"`
	...
	// Client signing keys.
	SigningKeys []*PostClientsResponseSigningKeysItems0 `json:"signing_keys"`
...
// Validate validates this post clients response
func (m *PostClientsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostClientsResponse) validateEncryptionKey(formats strfmt.Registry) error {
...
func (m *PostClientsResponse) validateJwtConfiguration(formats strfmt.Registry) error {
...
func (m *PostClientsResponse) validateMobile(formats strfmt.Registry) error {
...
func (m *PostClientsResponse) validateSigningKeys(formats strfmt.Registry) error {
...
var postClientsResponseTypeTokenEndpointAuthMethodPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		postClientsResponseTypeTokenEndpointAuthMethodPropEnum = append(postClientsResponseTypeTokenEndpointAuthMethodPropEnum, v)
	}
}

const (

	// PostClientsResponseTokenEndpointAuthMethodNone captures enum value "none"
	PostClientsResponseTokenEndpointAuthMethodNone string = "none"

	// PostClientsResponseTokenEndpointAuthMethodClientSecretPost captures enum value "client_secret_post"
	PostClientsResponseTokenEndpointAuthMethodClientSecretPost string = "client_secret_post"

	// PostClientsResponseTokenEndpointAuthMethodClientSecretBasic captures enum value "client_secret_basic"
	PostClientsResponseTokenEndpointAuthMethodClientSecretBasic string = "client_secret_basic"
)

// prop value enum
func (m *PostClientsResponse) validateTokenEndpointAuthMethodEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, postClientsResponseTypeTokenEndpointAuthMethodPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *PostClientsResponse) validateTokenEndpointAuthMethod(formats strfmt.Registry) error {
...
func (m *PostClientsResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PostClientsResponse) UnmarshalBinary(b []byte) error {
	var res PostClientsResponse
...
// PostClientsResponseSigningKeysItems0 post clients response signing keys items0
// swagger:model PostClientsResponseSigningKeysItems0
type PostClientsResponseSigningKeysItems0 struct {
...
// Validate validates this post clients response signing keys items0
func (m *PostClientsResponseSigningKeysItems0) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *PostClientsResponseSigningKeysItems0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *PostClientsResponseSigningKeysItems0) UnmarshalBinary(b []byte) error {
	var res PostClientsResponseSigningKeysItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
