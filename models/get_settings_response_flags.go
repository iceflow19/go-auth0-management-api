...
// GetSettingsResponseFlags Tenant flags
// swagger:model get_settings_response_flags
type GetSettingsResponseFlags struct {
...
// Validate validates this get settings response flags
func (m *GetSettingsResponseFlags) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *GetSettingsResponseFlags) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetSettingsResponseFlags) UnmarshalBinary(b []byte) error {
	var res GetSettingsResponseFlags
