...
// GetClientsByIDResponse get clients by id response
// swagger:model get_clients_by_id_response
type GetClientsByIDResponse struct {

	// addons
	Addons GetClientsByIDResponseAddons `json:"addons,omitempty"`
	...
	// client metadata
	ClientMetadata GetClientsByIDResponseClientMetadata `json:"client_metadata,omitempty"`
	...
	// encryption key
	EncryptionKey *GetClientsByIDResponseEncryptionKey `json:"encryption_key,omitempty"`
	...
	// jwt configuration
	JwtConfiguration *GetClientsByIDResponseJwtConfiguration `json:"jwt_configuration,omitempty"`

	// The URL of the client logo (recommended size: 150x150)
	LogoURI string `json:"logo_uri,omitempty"`

	// mobile
	Mobile *GetClientsByIDResponseMobile `json:"mobile,omitempty"`
	...
	// Client signing keys.
	SigningKeys []*GetClientsByIDResponseSigningKeysItems0 `json:"signing_keys"`
...
// Validate validates this get clients by id response
func (m *GetClientsByIDResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetClientsByIDResponse) validateEncryptionKey(formats strfmt.Registry) error {
...
func (m *GetClientsByIDResponse) validateJwtConfiguration(formats strfmt.Registry) error {
...
func (m *GetClientsByIDResponse) validateMobile(formats strfmt.Registry) error {
...
func (m *GetClientsByIDResponse) validateSigningKeys(formats strfmt.Registry) error {
...
var getClientsByIdResponseTypeTokenEndpointAuthMethodPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		getClientsByIdResponseTypeTokenEndpointAuthMethodPropEnum = append(getClientsByIdResponseTypeTokenEndpointAuthMethodPropEnum, v)
	}
}

const (

	// GetClientsByIDResponseTokenEndpointAuthMethodNone captures enum value "none"
	GetClientsByIDResponseTokenEndpointAuthMethodNone string = "none"

	// GetClientsByIDResponseTokenEndpointAuthMethodClientSecretPost captures enum value "client_secret_post"
	GetClientsByIDResponseTokenEndpointAuthMethodClientSecretPost string = "client_secret_post"

	// GetClientsByIDResponseTokenEndpointAuthMethodClientSecretBasic captures enum value "client_secret_basic"
	GetClientsByIDResponseTokenEndpointAuthMethodClientSecretBasic string = "client_secret_basic"
)

// prop value enum
func (m *GetClientsByIDResponse) validateTokenEndpointAuthMethodEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, getClientsByIdResponseTypeTokenEndpointAuthMethodPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *GetClientsByIDResponse) validateTokenEndpointAuthMethod(formats strfmt.Registry) error {
...
func (m *GetClientsByIDResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetClientsByIDResponse) UnmarshalBinary(b []byte) error {
	var res GetClientsByIDResponse
...
// GetClientsByIDResponseSigningKeysItems0 get clients by ID response signing keys items0
// swagger:model GetClientsByIDResponseSigningKeysItems0
type GetClientsByIDResponseSigningKeysItems0 struct {
...
// Validate validates this get clients by ID response signing keys items0
func (m *GetClientsByIDResponseSigningKeysItems0) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *GetClientsByIDResponseSigningKeysItems0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *GetClientsByIDResponseSigningKeysItems0) UnmarshalBinary(b []byte) error {
	var res GetClientsByIDResponseSigningKeysItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
