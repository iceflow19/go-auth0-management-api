...
// GetLogsResponse get logs response
// swagger:model get_logs_response
type GetLogsResponse struct {
	...
	// details
	Details GetLogsResponseDetails `json:"details,omitempty"`

	// The IP of the log event source
	IP *string `json:"ip,omitempty"`

	// location info
	LocationInfo GetLogsResponseLocationInfo `json:"location_info,omitempty"`
