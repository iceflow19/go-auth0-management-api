...
// PostClientsBodyAzureBlob post clients body azure blob
// swagger:model post_clients_body_azure_blob
type PostClientsBodyAzureBlob struct {
...
// Validate validates this post clients body azure blob
func (m *PostClientsBodyAzureBlob) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostClientsBodyAzureBlob) validateExpiration(formats strfmt.Registry) error {
...
func (m *PostClientsBodyAzureBlob) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PostClientsBodyAzureBlob) UnmarshalBinary(b []byte) error {
	var res PostClientsBodyAzureBlob
