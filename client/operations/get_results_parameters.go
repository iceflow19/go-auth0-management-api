...
// WithJobID adds the jobID to the get results params
func (o *GetResultsParams) WithJobID(jobID string) *GetResultsParams {
	o.SetJobID(jobID)
	return o
}

// SetJobID adds the jobId to the get results params
func (o *GetResultsParams) SetJobID(jobID string) {
	o.JobID = jobID
}
