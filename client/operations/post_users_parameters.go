...
func (o *PostUsersParams) WithBody(body *models.PostUsersBody) *PostUsersParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post users params
func (o *PostUsersParams) SetBody(body *models.PostUsersBody) {
	o.Body = body
}
