...
// WithID adds the id to the get errors params
func (o *GetErrorsParams) WithID(id string) *GetErrorsParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get errors params
func (o *GetErrorsParams) SetID(id string) {
	o.ID = id
}
